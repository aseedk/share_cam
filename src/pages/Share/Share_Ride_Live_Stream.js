...
const Share_Ride_Share_Live = ({navigation, route}) =>{
    ...
    React.useEffect(() => {
        ...
        return () => {
            database.ref('Streams/' + link + "/historyCoordinates").off();
            setCoordinates([0, 0]);
        };
    }, [link]);
    return(
...
export default Share_Ride_Share_Live;
