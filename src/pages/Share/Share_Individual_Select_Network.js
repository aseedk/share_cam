...
const Share_Individual_Select_Network = ({navigation}) =>{
                        ...
                        <TouchableOpacity style={{width:'20%', backgroundColor:'black', justifyContent:'center', alignItems:'center'}}
                                          onPress={()=> {
                                              if (selectedContacts.length > 0) {
                                                  navigation.replace('Share Individual Live Stream', {
...
export default Share_Individual_Select_Network;
